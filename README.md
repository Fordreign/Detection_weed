...
В этом репозитории я опишу как я обучал модель на данных - train-yolov8l.ipynb

Реализация телеграм-бота - bot.py


P.S. Можно настроить бота на детекцию сорняков на видео(я уже реализовал такой бот, можете его скопировать , он находится в общем доступе на моем гитхабе) и даже трекинг, но целесообразно уже встроить данный инструмент в ОП БПЛА.
